local module = {
	['Sounds'] = {
		['Purchase'] = false, -- The sound that plays when a player buys a button he can afford
		['Collect'] = false, -- The sound that plays when a player collects his currency
		['ErrorBuy'] = false -- The sound that plays when a player buys a button he can't afford
	...
	['FadeInTime'] = 0.5,
	['LeaderboardSettings'] = {
		['KOs'] = false, -- KnockOuts will show on the leaderboard
	...
	['StealSettings'] = {
		...
		['StealPrecent'] = 0.5, -- This is the precent of their currency you can take! (1 = all of the currency)
		['PlayerProtection'] = 30 -- This is the time in seconds in which the player can not be stolen from
	},
	['AutoCollect'] = {
		['Cooldown'] = 3,
		['Collect'] = true,
